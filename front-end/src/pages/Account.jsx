  ...
  return (
    <main className="bg-[#101010] w-full flex flex-grow justify-center items-center overflow-y-auto h-screen p-0 pt-[4rem]">
      <div className="flex flex-col items-center w-full max-w-100 !p-4">
        <h1 className="font-semibold text-3xl text-center mb-10 text-white">
          Minha Conta
        </h1>
        ...
        <button
          ...
          className="bg-[#3FE168] text-white cursor-pointer font-semibold uppercase w-full max-w-[240px] h-[45px] rounded-full mb-4"
        >
          Trocar Email
        </button>
        <button
          id="password"
          onClick={handleButton}
          className="bg-[#3FE168] text-white cursor-pointer font-semibold uppercase w-full max-w-[240px] h-[45px] rounded-full"
        >
          Trocar Senha
        </button>
      </div>
      ...
      {isChangingEmail && (
        <div className="absolute">
          <div
            className="bg-neutral-900 fixed opacity-75 text-white w-[100vw] h-full top-0 right-0 z-10"
            id="cancelar"
            onClick={handleButton}
          ></div>
          <div
            className="text-white bg-black z-50 h-auto place-self-center mx-auto relative justify-items-center p-6 rounded-xl
            ...
            >
              <div className="flex">
                ...
                <img
                  src={mailIcon}
                  alt="Mail icon"
                  className="absolute right-[10px] top-1.5"
                />
              </div>
              ...
              <div className="flex gap-5 place-items-center justify-center mb-3 mt-2">
                <button
                  id="cancelar"
                  onClick={handleButton}
                  className="bg-red-500 text-white cursor-pointer font-semibold uppercase w-35 h-[45px] rounded-full place-self-center"
                >
                  Cancelar
                </button>
                ...
                <button
                  id="password"
                  type="submit"
                  className="bg-[#3FE168] text-white cursor-pointer font-semibold uppercase w-35 h-[45px] rounded-full place-self-center"
                >
      ...
      {isChangingPassword && (
        <div className="absolute">
          ...
          >
            ...
            <form
              className="flex relative flex-col gap-10 w-full"
